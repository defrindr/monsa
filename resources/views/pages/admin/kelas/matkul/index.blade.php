<div class="card card-default">
    <div class="card-header">
        {{-- tombol --}}
        <a class="btn btn-primary" href="{{ route('admin.matkul.create') }}">
                ...
                @else
                    @foreach ($paginate as $item)
                        <tr>
                            ...
                            <td>{{ $item->name }}</td>
                            <td>
                                <a href="{{ route('admin.matkul.edit', $item) }}" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.matkul.destroy', $item) }}" method="POST"
